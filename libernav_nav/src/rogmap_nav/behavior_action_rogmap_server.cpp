// New RecoveryRogMapServer implementation using LiberNavActionBase framework.
...
: nav2_util::LifecycleNode(
    "libernav_behavior_server", parent_namespace,
    rclcpp::NodeOptions().arguments(
      {"--ros-args", "-r",
        std::string("libernav_behavior_server") + ":" +
        std::string("__node:=libernav_behavior_server")}
    ).enable_rosout(false)),
  plugin_loader_("libernav_rogmap_core", "libernav_rogmap_core::Recovery"),
  default_ids_{},
  default_types_{},
...
bool RecoveryRogMapServer::loadBehaviorPlugins()
{
  ...
  for (size_t i = 0; i < behavior_ids_.size(); i++) {
    ...
    try {
      ...
      libernav_rogmap_core::Recovery::Ptr behavior =
