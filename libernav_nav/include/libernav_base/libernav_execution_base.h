 ...
 * **Thread Model:**
 * ```
 * Main Thread (LiberNavActionBase::start)
 *   ├─ Create LiberNavExecutionBase instance
 *   └─ Call start() to spawn execution thread
 *        │
 *        └─ New Thread (LiberNavActionBase::run)
 *            ├─ preRun()  [setup]
...
public:
  /**
   * @brief Constructor for LiberNavExecutionBase
   *
