#pragma once
// New ControllerRogMapServer using LiberNavActionBase framework.
...
#include "libernav_rogmap_core/controller.hpp"
...
#include "libernav_utility/robot_information.h"
#include "libernav_base/controller_action.h"
#include "libernav_base/controller_execution.h"
 ...
 *        FollowPath action server using the LiberNavActionBase framework.
 *
...
public:
  using ControllerMap =
    std::unordered_map<std::string, libernav_rogmap_core::Controller::Ptr>;
...
private:
  ...
  // -------- plugins --------
  pluginlib::ClassLoader<libernav_rogmap_core::Controller> lp_loader_;
  ...
  // -------- ROS2 resources --------
  std::shared_ptr<libernav_rog_map::RogMapROS> rog_map_ros_;
  libernav_utility::RobotInformation::ConstPtr robot_info_;
