...
#ifndef LIBERNAV_SCAN_PLANNER__SCAN_CONTROLLER_HPP_
#define LIBERNAV_SCAN_PLANNER__SCAN_CONTROLLER_HPP_
...
class ScanController : public libernav_rogmap_core::Controller
{
public:
  void configure(
  ...
  void setTrajectory(const libernav_rogmap_core::Trajectory3D & trajectory) override;
...
private:
  ...
  libernav_rogmap_core::Trajectory3D input_trajectory_;
  ...
  std::string trajectory_topic_{"libernav_scan_planner/optimized_path"};
...
#endif  // LIBERNAV_SCAN_PLANNER__SCAN_CONTROLLER_HPP_
