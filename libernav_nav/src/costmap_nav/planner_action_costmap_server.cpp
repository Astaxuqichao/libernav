...
#include "libernav_nav/costmap_nav/planner_action_costmap_server.hpp"
  ...
  const rclcpp_lifecycle::State & /*state*/)
{
  ...
  action_server_get_path_ptr_ = rclcpp_action::create_server<ActionToPose>(
    ...
    std::bind(
      &libernav_nav::PlannerCostmapServer::handleGoalGetPath, this,
      _1, _2),
    std::bind(
      &libernav_nav::PlannerCostmapServer::cancelActionGetPath, this,
      _1),
    std::bind(
      &libernav_nav::PlannerCostmapServer::callActionGetPath, this,
      _1),
