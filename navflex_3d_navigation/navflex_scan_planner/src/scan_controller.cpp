...
#include "navflex_scan_planner/scan_controller.hpp"
  ...
  navflex_rog_map::RogMap::ConstPtr map)
{
  ...
  declare("trajectory_topic", std::string("navflex_scan_planner/optimized_path"));
...
PLUGINLIB_EXPORT_CLASS(
  navflex_scan_planner::ScanController,
