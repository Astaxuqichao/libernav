 ...
 * @tparam Execution A class derived from LiberNavExecutionBase representing the
 * task
 *
...
public:
  /**
   * @brief Constructor for LiberNavActionBase
   *
   ...
   */
  virtual ~LiberNavActionBase() {cleanupAllSlots();}
