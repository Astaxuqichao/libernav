 ...
 * @brief Action handler for DummyBehavior using the LiberNavActionBase framework.
 *
 ...
 * LiberNavActionBase will always return 0 via the if constexpr path.
 */
class BehaviorAction
  : public LiberNavActionBase<nav2_msgs::action::DummyBehavior,
    BehaviorExecution>
{
public:
  ...
  /**
   * @brief Execute behavior recovery (implements LiberNavActionBase).
   *
