...
namespace libernav_autonomous_exploration_bt
{
    ...
    cancel_requested_(false), active_(false)
  {
    ...
    declare_parameter(
      "plugin_lib_names", std::vector<std::string>{
        ...
        "libernav_get_path_action",
        "libernav_exe_path_action",
        "libernav_recovery_action"});
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<libernav_autonomous_exploration_bt::ExplorationBtNavigator>();
