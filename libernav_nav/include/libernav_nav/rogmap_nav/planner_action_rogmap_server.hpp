...
#include "libernav_base/planner_action.h"
#include "libernav_base/planner_execution.h"
...
public:
  ...
  using PlannerMap =
    std::unordered_map<std::string, libernav_rogmap_core::GlobalPlanner::Ptr>;
  ...
  explicit PlannerRogMapServer(
    const std::shared_ptr<libernav_rog_map::RogMapROS> rog_map_ros,
...
protected:
  ...
  libernav_nav::PlannerExecution::Ptr newPlannerExecution(
...
private:
  ...
  pluginlib::ClassLoader<libernav_rogmap_core::GlobalPlanner> gp_loader_;
