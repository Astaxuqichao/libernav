 ...
 *
 * **Responsibilities:**
 * - Implement runImpl() from LiberNavActionBase
 ...
 * - runImpl() execution: Dedicated execution thread (from LiberNavActionBase)
 */
class PlannerAction
  : public LiberNavActionBase<nav2_msgs::action::ComputePathToPose,
    PlannerExecution>
{
public:
  // ========== Type Definitions ==========
  ...
  /**
   * @brief Execute path planning for a goal (implements LiberNavActionBase)
   *
   * **Execution Sequence:**
