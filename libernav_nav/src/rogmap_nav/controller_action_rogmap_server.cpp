// New ControllerRogMapServer implementation using LiberNavActionBase framework.
...
: nav2_util::LifecycleNode(
    "libernav_controller_server", parent_namespace,
    rclcpp::NodeOptions().arguments(
      {"--ros-args", "-r",
        std::string("libernav_controller_server") + ":" +
        std::string("__node:=libernav_controller_server")}
    ).enable_rosout(false)),
  lp_loader_("libernav_rogmap_core", "libernav_rogmap_core::Controller"),
  default_ids_{},
  default_types_{},
  ...
  const rclcpp_lifecycle::State & /*state*/)
{
  ...
  for (size_t i = 0; i < controller_ids_.size(); i++) {
    try {
      ...
      libernav_rogmap_core::Controller::Ptr ctrl =
  ...
  const rclcpp_lifecycle::State & /*state*/)
{
  ...
  // Break circular ref: LiberNavActionBase::node_ and RobotInformation::node_
