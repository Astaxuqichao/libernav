...
#include "libernav_nav/costmap_nav/controller_action_costmap_server.hpp"
#include "libernav_nav/costmap_nav/behavior_action_costmap_server.hpp"
...
private:
  ...
  std::shared_ptr<libernav_nav::PlannerCostmapServer> planner_server_;
  ...
  std::shared_ptr<libernav_nav::ControllerCostmapServer> controller_server_;
  ...
  std::shared_ptr<libernav_nav::BehaviorCostmapServer> behavior_server_;
