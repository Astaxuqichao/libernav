...
#ifndef NAVFLEX_SCAN_PLANNER__SCAN_CONTROLLER_HPP_
#define NAVFLEX_SCAN_PLANNER__SCAN_CONTROLLER_HPP_
...
private:
  ...
  std::string trajectory_topic_{"navflex_scan_planner/optimized_path"};
...
#endif  // NAVFLEX_SCAN_PLANNER__SCAN_CONTROLLER_HPP_
