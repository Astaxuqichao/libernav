 ...
 *
 * Mirrors the ControllerAction / ControllerCostmapServer in libernav_costmap_nav.
 ...
 *
 * BT node ID: LiberNavExePathAction
 *
 ...
 *
 * BT node ID: LiberNavCancelExePath
 *
 * BT XML example:
 * @code{.xml}
 *   <LiberNavCancelExePath server_name="/costmap/follow_path"/>
 * @endcode
 */
