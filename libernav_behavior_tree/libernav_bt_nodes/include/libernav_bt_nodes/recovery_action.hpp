 ...
 *
 * Mirrors the BehaviorAction / BehaviorCostmapServer in libernav_costmap_nav.
 ...
 *
 * BT node ID: LiberNavRecoveryAction
 *
 ...
 *
 * BT node ID: LiberNavCancelRecovery
 *
 * BT XML example:
 * @code{.xml}
 *   <LiberNavCancelRecovery server_name="/costmap/behavior_action"/>
 * @endcode
 */
