// Copyright (c) 2024 LiberNav
// SPDX-License-Identifier: Apache-2.0

#include "libernav_exclusion_zone/exclusion_zone_layer.hpp"
...
PLUGINLIB_EXPORT_CLASS(
  libernav_exclusion_zone::ExclusionZoneLayer,
  nav2_costmap_2d::Layer)

namespace libernav_exclusion_zone
{
