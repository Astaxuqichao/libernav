...
```bash
export RCUTILS_LOGGING_CONFIG_FILE=~/humble_ws/libernav_ws/ros2_spdlog_rotating.conf
export LD_PRELOAD=~/humble_ws/libernav_ws/install/rcl_logging_spdlog_rotating/lib/librcl_logging_spdlog_rotating.so
...
ws = os.path.expanduser('~/humble_ws/libernav_ws')
...
```bash
#!/bin/bash
source ~/humble_ws/libernav_ws/install/setup.bash
