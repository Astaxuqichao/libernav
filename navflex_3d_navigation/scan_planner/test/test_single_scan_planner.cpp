...
TEST(SingleScanPlanner, ProducesTimedTrajectoryFromReference)
{
  ...
  scan_planner::SingleScanPlannerConfig config;
  config.optimization_iterations = 5;
  scan_planner::SingleScanPlanner planner(config, map, footprint());
  scan_planner::TimedScanTrajectory trajectory;
  std::string message;
...
TEST(SingleScanPlanner, RepairsCollisionOnFinalReferenceEdge)
{
  ...
  scan_planner::SingleScanPlanner planner(config, map, small_footprint);
  scan_planner::TimedScanTrajectory trajectory;
  std::string message;
