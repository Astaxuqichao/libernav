...
#include "libernav_base/plugin_adapters.hpp"
 ...
 *
 * Runs the behavior in a dedicated thread (via LiberNavExecutionBase) and
 * tracks its state through the BehaviorState enum.
 */
class BehaviorExecution : public LiberNavExecutionBase
{
public:
