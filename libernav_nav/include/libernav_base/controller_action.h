...
#include "libernav_base/libernav_action_base.hpp"
 ...
 * @brief Action handler for the FollowPath action using the LiberNavActionBase
 *        concurrent-slot framework.
 *
 * Inherits from LiberNavActionBase<FollowPath, ControllerExecution>.
 ...
 */
class ControllerAction
  : public LiberNavActionBase<nav2_msgs::action::FollowPath, ControllerExecution>
{
public:
   ...
   * Otherwise falls back to the standard LiberNavActionBase::start() logic.
   */
  void start(
